                    ...
                    <div class="flex">
                        ...
                        <div class="hidden sm:-my-px sm:ml-6 sm:flex sm:space-x-8">
                            ...
                            <a href="{{route('tasks.index')}}"
                                class="inline-flex items-center px-1 pt-1 text-sm font-medium border-b-2  @if(Route::is('tasks.index')){{'border-indigo-500 text-gray-900'}} @else {{'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}} @endif"
                                aria-current="page"> Dashboard </a>

                            <a href="{{route('tasks.management.index')}}"
                                class="inline-flex items-center px-1 pt-1 text-sm font-medium border-b-2 @if(Route::is('tasks.management.*')){{'border-indigo-500 text-gray-900'}} @else {{'border-transparent text-gray-500 hover:border-gray-300 hover:text-gray-700'}} @endif">
                                Task Management </a>
